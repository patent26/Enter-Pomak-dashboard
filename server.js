...
// Inicijaliziraj JSONBin storage 2 sekunde nakon starta
setTimeout(async () => {
  try {
    await loadReport('init');
    console.log('💾 JSONBin storage inicijaliziran');
  } catch(e) {
    console.log('💾 JSONBin init:', e.message);
  }
}, 2000);
